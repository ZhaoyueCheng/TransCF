...
def parse_args():
    ...
    parser.add_argument('--reg1', type=float, default=0.001, help='Distance Regularization.')
    parser.add_argument('--reg2', type=float, default=0.001, help='Neighborhood Regularization.')
